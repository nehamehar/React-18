...
function Card({name = "samyak", btnText}) {
  console.log(name)
...
<div className="min-h-screen bg-[#121212]">
  <header className="fixed top-0 z-10 mx-auto w-full max-w-full bg-[#121212] p-6 text-white lg:px-10"><h1>DevUI</h1></header>
    ...
    <div class="mt-20 flex w-full flex-col items-start justify-start p-6 md:w-1/2 lg:px-10">
      ...
      <div class="my-14 flex w-full flex-col items-start justify-start gap-4">
        <div class="flex w-full flex-col items-start justify-start gap-2">
          <label class="text-xs text-slate-200">{name}</label>
          <input
...
export default Card   // exporting fun 